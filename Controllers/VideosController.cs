...
namespace WadoRyu.Controllers
{
    public class VideosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Url,DateAdded,VideoCategories,SelectedValue")] ViewModelTest vmVideo)
        {
            int parsedResult;

            if (int.TryParse(vmVideo.SelectedValue, out parsedResult))
            {
                var video = new Video
                {
                    Name = vmVideo.Name,
